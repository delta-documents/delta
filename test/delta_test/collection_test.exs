defmodule DeltaTest.CollectionTest do
  ...
  test "Delta.Collection.validate/1" do
  ...
  test "Delta.Collection.new/2 generates unique and correct uuid" do
  ...
  test "Delta.Collection.create/1 of invalid collection aborts transaction" do
    assert {:aborted, _} = Collection.create_transaction(%Collection{id: 123})
  end

  test "Delta.Collection.update/2 updates collection if one exists" do
    c = collection()
  ...
  test "Delta.Collection.delete/1 deletes documents and changes cascade" do
  ...
  test "Delta.Collection.delete/1 of non-existing collection is :ok" do
